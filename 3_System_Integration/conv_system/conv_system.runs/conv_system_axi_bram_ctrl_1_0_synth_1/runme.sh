...
HD_PWD='C:/Users/User/school/digi_sys_exp/DSProject_Final/3_System_Integration/conv_system/conv_system.runs/conv_system_axi_bram_ctrl_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conv_system_axi_bram_ctrl_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv_system_axi_bram_ctrl_1_0.tcl
