...
HD_PWD='C:/Users/User/school/digi_sys_exp/DSProject_Final/3_System_Integration/conv_system/conv_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log conv_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source conv_system_wrapper.tcl -notrace
