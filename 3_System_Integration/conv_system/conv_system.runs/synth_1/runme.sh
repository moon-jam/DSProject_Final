...
HD_PWD='C:/Users/User/school/digi_sys_exp/DSProject_Final/3_System_Integration/conv_system/conv_system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conv_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv_system_wrapper.tcl
